 ...
 *
 */
public class RelayAuctionOverMarketBehaviour extends OneShotBehaviour
{
	 ...
	 */
	public RelayAuctionOverMarketBehaviour(
	...
	public void action()
	{
		...
		// Close auction
		myMarketAgent.notifyAuctionOver(
				this.myFSM.getAuctionId(),
				this.myFSM.getSelectedBidder().getLocalName());
