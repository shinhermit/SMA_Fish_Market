...
import fr.univpau.m2ti.sma.fishmarket.auction.create.fsm.market.states.ConfirmCreationMarketBehaviour;
 ...
 *
 */
public class CreateAuctionMarketFSMBehaviour extends FSMBehaviour
{
	 ...
	 */
	public CreateAuctionMarketFSMBehaviour(MarketAgent myMarketAgent)
	{
		super(myMarketAgent);
		
		// Register states
		// The last state must call myMarketAgent.setIsDone(true);	
		this.registerFirstState(new WaitCreationRequestMarketBehaviour(myMarketAgent, this),
				STATE_WAIT_REQUEST);
		
		this.registerState(new EvaluateCreationResquestMarketBehaviour(myMarketAgent, this),
				STATE_EVALUATE_REQUEST);
		
		this.registerState(new ConfirmCreationMarketBehaviour(myMarketAgent, this),
				STATE_ACCEPT_CREATION);
		
		this.registerLastState(new TerminateCreationMarketBehaviour(myMarketAgent),
				STATE_TERMINATE);
