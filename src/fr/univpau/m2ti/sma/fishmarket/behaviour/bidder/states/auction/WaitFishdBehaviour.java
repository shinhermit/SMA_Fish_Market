 ...
 *
 */
public class WaitFishdBehaviour extends OneShotBehaviour
{
    /** Logging. */
    private static final Logger LOGGER =
            Logger.getLogger(WaitFishdBehaviour.class.getName());

    private BidderBehaviour myFSM;

    public WaitFishdBehaviour(Agent a, BidderBehaviour fsm)
    {
        super(a);
        this.myFSM = fsm;
    }
