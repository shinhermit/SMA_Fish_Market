 ...
 *
 */
public class WaitToGiveBehaviour extends Behaviour
{
	...
	private static final Logger LOGGER =
			Logger.getLogger(WaitToGiveBehaviour.class.getName());
	...
	private MessageTemplate createFilter()
	{
		...
		{
			WaitToGiveBehaviour.LOGGER.log(Level.SEVERE, null, e);
		}
